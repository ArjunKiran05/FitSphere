...
public class UserService {
    ...
    public Mono<Boolean> validateUser(String userId){
        ...
        return userServiceWebClient.get().uri("/api/users/{userId}/validate",userId).retrieve().bodyToMono(Boolean.class).onErrorResume(WebClientResponseException.class,e->{
